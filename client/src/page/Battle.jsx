...
const Battle = () => {
  ...
  //       ) {
  //         player01Address = gameData.activePlayer.players[0];
  //         player02Address = gameData.activePlayer.players[1];
  //       } else {
  //         player01Address = gameData.activePlayer.players[1];
  //         player02Address = gameData.activePlayer.players[0];
  //       }
  ...
  //   if (contract && gameData.activePlayer) getPlayerInfo();
